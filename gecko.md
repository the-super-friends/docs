...
- Major interfaces used by the autocomplete UI layer:
  ...
  - [`nsIAutoCompleteItem`](https://developer.mozilla.org/en-US/docs/Mozilla/Tech/XPCOM/Reference/Interface/nsIAutoCompleteItem) - seems like it represents individual autocomplete result, includes a CSS class to be used in styling (*note: I can't actually find this interface anywhere? maybe the MDN docs are out of date?*)
